...
class NotificationManager:
    ...
    def send_sms(self, message_body):
        ...
        message = self.client.messages.create(
            from_=os.environ["TWILIO_VERIFIED_NUM"],
            body=message_body,
            to=os.environ["TWILIO_VERIFIED_NUM"]
        )
    ...
    def send_whatsapp(self, message_body):
        message = self.client.messages.create(
            from_=f'whatsapp:{os.environ["WHATSAPP_PHONE_NUMBER"]}',
            body=message_body,
            to=f'whatsapp:{os.environ["WHATSAPP_PHONE_NUMBER"]}'
        )
        print(message.sid)
