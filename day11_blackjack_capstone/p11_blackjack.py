...
def compare(user_score, computer_score):
    if user_score == computer_score:
        ...
        return "Soryy, you lose, dealer has Blackjack"
    elif user_score == 0:
        return "Blackjack!! You win!"
    elif user_score > 21:
        return f"Sorry you bust with {user_score}. You lose."
    elif computer_score > 21:
        return f"Dealer bust with {computer_score}. You win."
    elif user_score > computer_score:
        return "You beat the dealer. You win."
    else:
        return "Dealer hand wins. Sorry, you lose."
...
def play_blackjack():
    ...
    # Hint 5: Deal the user and computer 2 cards each using deal_card() and append(). [moved bc the calculate_score() function must be declared above before called]
    user_cards = []
    computer_cards = []
    game_over = False
    user_score = 0
    ...
    # user_cards = [deal_card(), deal_card()]
    # computer_cards = [deal_card(), deal_card()]
    # Instructor used a for loop instead of assignment [like my lines above]
    for _ in range(2):
